...
class _ScrollingMapBodyState extends State<ScrollingMapBody> {
  late MapboxFlutterMapController controllerOne;
  late MapboxFlutterMapController controllerTwo;
  ...
  void onMapCreatedOne(MapboxFlutterMapController controller) {
    this.controllerOne = controller;
  }

  void onMapCreatedTwo(MapboxFlutterMapController controller) {
    this.controllerTwo = controller;
  }

  void onStyleLoaded(MapboxFlutterMapController controller) {
