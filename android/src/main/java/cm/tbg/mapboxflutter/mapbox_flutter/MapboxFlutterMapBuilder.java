...
public class MapboxFlutterMapBuilder implements MapboxFlutterMapOptionsSink {
    ...
    MapboxFlutterMapController build(
            int id, Context context, BinaryMessenger messenger, MapboxFlutterPlugin.LifecycleProvider lifecycleProvider, String accessToken) {
        final MapboxFlutterMapController controller =
                new MapboxFlutterMapController(id, context,  messenger, lifecycleProvider, options, accessToken, styleString, annotationOrder, annotationConsumeTapEvents);
        controller.init();
