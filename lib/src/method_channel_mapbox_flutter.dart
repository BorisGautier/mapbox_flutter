...
class MethodChannelMapboxFlutter extends MapboxFlutterPlatfom {
  ...
  Future<void> initPlatform(int id) async {
    _channel = MethodChannel('plugins.flutter.io/mapbox_flutter_$id');
  ...
  Widget buildView(
    ...
    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
        viewType: 'plugins.flutter.io/mapbox_flutter',
