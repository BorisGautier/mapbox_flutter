...
typedef void MapCreatedCallback(MapboxFlutterMapController controller);

class MapboxFlutterMap extends StatefulWidget {
  const MapboxFlutterMap({
    Key? key,
  ...
  @override
  State createState() => _MapboxFlutterMapState();
}

class _MapboxFlutterMapState extends State<MapboxFlutterMap> {
  final Completer<MapboxFlutterMapController> _controller =
  ...
  @override
  void didUpdateWidget(MapboxFlutterMap oldWidget) {
  ...
  void _updateOptions(Map<String, dynamic> updates) async {
    ...
    final MapboxFlutterMapController controller = await _controller.future;
  ...
  Future<void> onPlatformViewCreated(int id) async {
    ...
    await MapboxFlutterMapController.initPlatform(id);
...
class _MapboxMapOptions {
  ...
  static _MapboxMapOptions fromWidget(MapboxFlutterMap map) {
