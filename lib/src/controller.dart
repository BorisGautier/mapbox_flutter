// Copyright 20 The Chromium Authors. All rights reserved.
...
class MapboxFlutterMapController extends ChangeNotifier {
  MapboxFlutterMapController._(this._id, CameraPosition initialCameraPosition,
    ...
    MapboxFlutterPlatfom.getInstance(_id).onLineTappedPlatform.add((lineId) {
    ...
    MapboxFlutterPlatfom.getInstance(_id).onFillTappedPlatform.add((fillId) {
    ...
    MapboxFlutterPlatfom.getInstance(_id).onCameraMoveStartedPlatform.add((_) {
    ...
    MapboxFlutterPlatfom.getInstance(_id).onMapStyleLoadedPlatform.add((_) {
      if (onStyleLoadedCallback != null) {
        onStyleLoadedCallback!();
      }
    });

    MapboxFlutterPlatfom.getInstance(_id).onMapClickPlatform.add((dict) {
      if (onMapClick != null) {
        onMapClick!(dict['point'], dict['latLng']);
      }
    });

    MapboxFlutterPlatfom.getInstance(_id).onMapLongClickPlatform.add((dict) {
      if (onMapLongClick != null) {
        onMapLongClick!(dict['point'], dict['latLng']);
      }
    });

    MapboxFlutterPlatfom.getInstance(_id).onAttributionClickPlatform.add((_) {
    ...
    MapboxFlutterPlatfom.getInstance(_id).onMapIdlePlatform.add((_) {
      if (onMapIdle != null) {
        onMapIdle!();
      }
    });
  ...
  static MapboxFlutterMapController init(
    ...
    return MapboxFlutterMapController._(id, initialCameraPosition,
        onStyleLoadedCallback: onStyleLoadedCallback,
  ...
  static Future<void> initPlatform(int id) async {
    await MapboxFlutterPlatfom.getInstance(id).initPlatform(id);
  }
  ...
  Future<bool?> animateCamera(CameraUpdate cameraUpdate) async {
    return MapboxFlutterPlatfom.getInstance(_id).animateCamera(cameraUpdate);
  }
  ...
  Future<bool?> moveCamera(CameraUpdate cameraUpdate) async {
    return MapboxFlutterPlatfom.getInstance(_id).moveCamera(cameraUpdate);
  }
  ...
  Future<void> setMapLanguage(String language) async {
    return MapboxFlutterPlatfom.getInstance(_id).setMapLanguage(language);
  }
  ...
  Future<void> setTelemetryEnabled(bool enabled) async {
    return MapboxFlutterPlatfom.getInstance(_id).setTelemetryEnabled(enabled);
  }
  ...
  Future<bool> getTelemetryEnabled() async {
    return MapboxFlutterPlatfom.getInstance(_id).getTelemetryEnabled();
  }
  ...
  Future<void> updateSymbol(Symbol symbol, SymbolOptions changes) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).updateSymbol(symbol, changes);
  ...
  Future<LatLng> getSymbolLatLng(Symbol symbol) async {
    assert(_symbols[symbol.id] == symbol);
    final symbolLatLng =
        await MapboxFlutterPlatfom.getInstance(_id).getSymbolLatLng(symbol);
    notifyListeners();
    return symbolLatLng;
  }
  ...
  Future<void> clearSymbols() async {
    await MapboxFlutterPlatfom.getInstance(_id).removeSymbols(_symbols.keys);
    _symbols.clear();
    notifyListeners();
  }
  ...
  Future<void> _removeSymbols(Iterable<String> ids) async {
    await MapboxFlutterPlatfom.getInstance(_id).removeSymbols(ids);
  ...
  Future<List<Line>> addLines(List<LineOptions> options,
      [List<Map>? data]) async {
    final lines =
        await MapboxFlutterPlatfom.getInstance(_id).addLines(options, data);
  ...
  Future<void> updateLine(Line line, LineOptions changes) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).updateLine(line, changes);
  ...
  Future<List<LatLng>> getLineLatLngs(Line line) async {
    assert(_lines[line.id] == line);
    final lineLatLngs =
        await MapboxFlutterPlatfom.getInstance(_id).getLineLatLngs(line);
    notifyListeners();
    return lineLatLngs;
  }
  ...
  Future<void> removeLine(Line line) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).removeLine(line.id);
  ...
  Future<void> removeLines(Iterable<Line> lines) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).removeLines(ids);
  ...
  Future<void> clearLines() async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).removeLines(lineIds);
    _lines.clear();
    notifyListeners();
  }
  ...
  Future<Circle> addCircle(CircleOptions options, [Map? data]) async {
    ...
    final circle = await MapboxFlutterPlatfom.getInstance(_id)
  ...
  Future<List<Circle>> addCircles(List<CircleOptions> options,
      [List<Map>? data]) async {
    final circles =
        await MapboxFlutterPlatfom.getInstance(_id).addCircles(options, data);
  ...
  Future<void> updateCircle(Circle circle, CircleOptions changes) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).updateCircle(circle, changes);
  ...
  Future<void> removeCircle(Circle circle) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).removeCircle(circle.id);
  ...
  Future<void> removeCircles(Iterable<Circle> circles) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).removeCircles(ids);
  ...
  Future<void> clearCircles() async {
    await MapboxFlutterPlatfom.getInstance(_id).removeCircles(_circles.keys);
    _circles.clear();
  ...
  Future<List<Fill>> addFills(List<FillOptions> options,
      [List<Map>? data]) async {
    final circles =
        await MapboxFlutterPlatfom.getInstance(_id).addFills(options, data);
  ...
  Future<void> updateFill(Fill fill, FillOptions changes) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).updateFill(fill, changes);
  ...
  Future<void> clearFills() async {
    await MapboxFlutterPlatfom.getInstance(_id).removeFills(_fills.keys);
    _fills.clear();
  ...
  Future<void> removeFill(Fill fill) async {
    assert(_fills[fill.id] == fill);
    await MapboxFlutterPlatfom.getInstance(_id).removeFill(fill.id);
  ...
  Future<void> removeFills(Iterable<Fill> fills) async {
    ...
    await MapboxFlutterPlatfom.getInstance(_id).removeFills(ids);
  ...
  Future invalidateAmbientCache() async {
    return MapboxFlutterPlatfom.getInstance(_id).invalidateAmbientCache();
  }
  ...
  Future<LatLng?> requestMyLocationLatLng() async {
    return MapboxFlutterPlatfom.getInstance(_id).requestMyLocationLatLng();
  }
  ...
  Future<void> addImage(String name, Uint8List bytes, [bool sdf = false]) {
    return MapboxFlutterPlatfom.getInstance(_id).addImage(name, bytes, sdf);
  }
  ...
  Future<Point> toScreenLocation(LatLng latLng) async {
    return MapboxFlutterPlatfom.getInstance(_id).toScreenLocation(latLng);
  }

  Future<List<Point>> toScreenLocationBatch(Iterable<LatLng> latLngs) async {
    return MapboxFlutterPlatfom.getInstance(_id).toScreenLocationBatch(latLngs);
  }
  ...
  Future<LatLng> toLatLng(Point screenLocation) async {
    return MapboxFlutterPlatfom.getInstance(_id).toLatLng(screenLocation);
  }
