...
abstract class MapboxFlutterPlatfom {
  /// The default instance of [MapboxFlutterPlatfom] to use.
  ///
  /// Defaults to [MethodChannelMapboxGl].
  ///
  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [MapboxFlutterPlatfom] when they register themselves.
  static MapboxFlutterPlatfom Function() createInstance =
      () => MethodChannelMapboxFlutter();

  static Map<int, MapboxFlutterPlatfom> _instances = {};

  static void addInstance(int id, MapboxFlutterPlatfom platform) {
    _instances[id] = platform;
  }

  static MapboxFlutterPlatfom getInstance(int id) {
