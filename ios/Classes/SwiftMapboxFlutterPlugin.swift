...
public class SwiftMapboxFlutterPlugin: NSObject, FlutterPlugin {
    public static func register(with registrar: FlutterPluginRegistrar) {
          ...
          registrar.register(instance, withId: "plugins.flutter.io/mapbox_flutter")


          let channel = FlutterMethodChannel(name: "plugins.flutter.io/mapbox_flutter", binaryMessenger: registrar.messenger())
